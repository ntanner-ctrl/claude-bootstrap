...
- **Insight capture:** Prerequisite gaps and design boundary discoveries are prime findings material. Run `/collect-insights` to flush to vault + epistemic tracking.
