...
- **Insight capture:** Design decisions embedded in the spec are findings. Run `/collect-insights` after spec completion to flush architectural choices and trade-off rationale to vault + epistemic tracking
